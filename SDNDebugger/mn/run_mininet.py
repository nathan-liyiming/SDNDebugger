...
if __name__ == '__main__':
    ...
    net = Mininet(topo=topo, autoSetMacs=True, controller=partial(RemoteController, ip='127.0.0.1', port=8000), switch=customConstructor({'ovsk' : OVSSwitch}, "ovsk,protocols=OpenFlow13"))
