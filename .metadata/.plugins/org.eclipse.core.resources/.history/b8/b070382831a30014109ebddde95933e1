...
public class StatefulFirewallMonitorHandler implements Runnable {
	...
	// expectedEvents are events that expected to happened in the real network generated by Oracle
	...
	private void initOracle() {
		...
		this.expectedEvents.add("of_packet_out"); // arp response generated by the
												// controller
		this.expectedEvents.add("Echo (ping) request"); // icmp ping request sent
		...
		this.expectedEvents.add("Echo (ping) request"); // ping request sent from
														// h1 reached h2
		this.expectedEvents.add("of_packet_in"); // arp request sent from h2
		this.expectedEvents.add("of_packet_out"); // arp response generated by the
												// controller
		this.expectedEvents.add("Echo (ping) reply"); // ping reply arrive at the
													// switch
		this.expectedEvents.add("Echo (ping) reply"); // ping reply arrive at the
													// h1
		// afterward flow
