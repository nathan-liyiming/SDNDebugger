...
public class OFError extends OFMessage implements OFMessageFactoryAware {
    ...
    public enum OFErrorType {
        ...
        OFPET_TABLE_FEATURES_FAILED, OFPET_EXPERIMENTER;
    ...
    public enum OFBadRequestCode {
        OFPBRC_BAD_VERSION, OFPBRC_BAD_TYPE, OFPBRC_BAD_STATS, OFPBRC_BAD_EXPERIMENTER, OFPBRC_BAD_EXP_TYPE,
    ...
    public enum OFBadActionCode {
        OFPBAC_BAD_TYPE, OFPBAC_BAD_LEN, OFPBAC_BAD_EXPERIMENTER, OFPBAC_BAD_EXP_TYPE, 
    ...
    public enum OFBadInstructionCode {
        ...
        OFPBIC_BAD_EXPERIMENTER, OFPBIC_BAD_EXP_TYPE, OFPBIC_BAD_LEN, OFPBIC_EPERM 
    }
